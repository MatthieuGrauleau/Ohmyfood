...
Quatrième projet du parcous " Intégrateur web " chez OpenClassroom. J'avais pour objectif d'intégrer la maquette puis de dynamiser une page web avec des animations CSS en utilisant le préprocesseur Sass.


## Objectifs

1. Création du site web en "mobile first"
2. Ajouter des animations en CSS
## Livrables
